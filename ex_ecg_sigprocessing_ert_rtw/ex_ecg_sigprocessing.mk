###########################################################################
## Makefile generated for Simulink model 'ex_ecg_sigprocessing'. 
## 
## Makefile     : ex_ecg_sigprocessing.mk
## Generated on : Sat Jan 09 00:19:59 2021
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ex_ecg_sigprocessing.exe
...
PRODUCT_NAME              = ex_ecg_sigprocessing
MAKEFILE                  = ex_ecg_sigprocessing.mk
COMPUTER                  = PCWIN64
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = ex_ecg_sigprocessing_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = ex_ecg_sigprocessing_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ex_ecg_sigprocessing.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/ex_ecg_sigprocessing_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/dsp/dspdemos -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=ex_ecg_sigprocessing -DNUMST=4 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/ex_ecg_sigprocessing_ert_rtw/ex_ecg_sigprocessing.c $(START_DIR)/ex_ecg_sigprocessing_ert_rtw/ex_ecg_sigprocessing_data.c
...
OBJS = ex_ecg_sigprocessing.obj ex_ecg_sigprocessing_data.obj
...
%.obj : $(START_DIR)/ex_ecg_sigprocessing_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
